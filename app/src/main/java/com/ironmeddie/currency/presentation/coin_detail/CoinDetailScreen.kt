...
import com.ironmeddie.currency.presentation.coin_detail.components.CoinTag
import com.ironmeddie.currency.presentation.coin_detail.components.TeamListItem


@Composable
fun CoinDetailScreen(
    viewModel: CoinDeyailViewModel = hiltViewModel()
){
